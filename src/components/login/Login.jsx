...
import stylesLogin2 from '../../css/login.module.css';
        ...
        <div className='container'>
            ...
            <div className='mt-2'>
                ...
                <Carousel className="carousel-style"
                    showThumbs={false} autoPlay={true} infiniteLoop={true} className={`mt-3 ${stylesLogin2.carouselEdit}`}>
                    <div>
                        <img src={campaignOne} />
                ...
                <div className='w-100'>
                    ...
                    <Button
                        variant="contained" className={`${stylesWelcome.pdButton} ${stylesWelcome.buttonLogin} mt-4`}>Login</Button>
                </div>
